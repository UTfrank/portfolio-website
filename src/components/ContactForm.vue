      ...
      <div class="bg-zinc-900/80 border border-white/5 rounded-[2rem] p-8 md:p-12 relative z-10 backdrop-blur-xl shadow-2xl">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <button 
            type="submit" 
            :disabled="isLoading"
            class="w-full bg-blue-200 hover:bg-blue-300 text-black font-semibold py-4 px-8 rounded-xl transition-colors flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed mt-4"
          >
